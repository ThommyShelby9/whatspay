...
Route::middleware(['auth'])->prefix('admin/influencer')->group(function () {
    ...
    Route::get('/agent/campaigns/accepted', [CampaignController::class, 'accepted'])
        ->name('influencer.campaigns.accepted');
    Route::put('/agent/campaigns/{id}/accepte', [CampaignController::class, 'accepte'])
        ->name('influencer.campaigns.accepte');
