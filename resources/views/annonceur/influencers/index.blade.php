                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">{{ $influencer->locality ?? 'N/A' }},
                                        {{ $influencer->country ?? 'N/A' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="progress" style="height: 5px;">
                                    ...
                                    <div class="progress-bar bg-success" role="progressbar"
                                        style="width: {{ $viewsPercent }}%" aria-valuenow="{{ $viewsPercent }}"
                            ...
                            <div class="mt-3 text-center">
                                <a href="{{ route('announcer.influencers.show', ['id' => $influencer->id]) }}"
