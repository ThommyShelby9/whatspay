  ...
  <div class="row">
    <div class="col-xl-12">
      <div class="card">
        ...
        <div class="card-body">
          <form id="createCampaignForm" method="post" action="{{ route('announcer.campaigns.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control" name="descriptipon" rows="3" placeholder="Décrivez l'objectif de votre campagne..."></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control" name="legend" rows="3" required placeholder="Texte qui accompagnera votre média..."></textarea>
  ...
  <div class="col-md-12">
    <div class="form-group mb-3">
      ...
      <div class="p-3 border rounded bg-light text-center">
        ...
        <div class="mt-3">
          <input type="file" id="campaign-files" name="campaign_files[]" class="form-control" multiple accept="image/*,video/*">
        </div>
 ...
 $(document).ready(function() {
  ...
  $('#createCampaignForm').submit(function(e) {
      ...
      if (mediaType === 'image' || mediaType === 'image_link') {
        for (let i = 0; i < files.length; i++) {
          if (!files[i].type.match('image.*')) {
            e.preventDefault();
            alert('Pour le type de média "image", seuls les fichiers image sont autorisés.');
            return false;
          }
        }
      } else if (mediaType === 'video') {
        for (let i = 0; i < files.length; i++) {
          if (!files[i].type.match('video.*')) {
            e.preventDefault();
            alert('Pour le type de média "vidéo", seuls les fichiers vidéo sont autorisés.');
            return false;
          }
        }
      }
    ...
    const requiredFields = [
      { name: 'name', message: 'Veuillez saisir un nom pour la campagne.' },
      { name: 'budget', message: 'Veuillez spécifier un budget pour la campagne.' },
      { name: 'startdate', message: 'Veuillez sélectionner une date de début.' },
      { name: 'enddate', message: 'Veuillez sélectionner une date de fin.' },
      { name: 'locality_id', message: 'Veuillez sélectionner une localité cible.' },
      { name: 'occupation_id', message: 'Veuillez sélectionner une profession cible.' },
      { name: 'legend', message: 'Veuillez saisir une légende pour le média.' }
    ];
