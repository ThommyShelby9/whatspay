                ...
                <div class="col-md-3">
                  <div class="form-group mb-3">
                    ...
                    <select class="form-select" name="filtre_status">
                      ...
                      <option value="PENDING" {{ request()->get('filtre_status') == "PENDING" ? 'selected' : '' }}>En attente</option>
                      <option value="ACCEPTED" {{ request()->get('filtre_status') == "ACCEPTED" ? 'selected' : '' }}>Acceptées</option>
                      <option value="PAID" {{ request()->get('filtre_status') == "PAID" ? 'selected' : '' }}>Payées</option>
                      <option value="REJECTED" {{ request()->get('filtre_status') == "REJECTED" ? 'selected' : '' }}>Rejetées</option>
                      <option value="CLOSED" {{ request()->get('filtre_status') == "CLOSED" ? 'selected' : '' }}>Fermées</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-3">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <small class="text-muted">{{ Str::limit($campaign->descriptipon ?? '', 40) }}</small>
                  </td>
                  <td>
                    <span class="badge bg-success">{{ number_format($campaign->budget ?? 0) }} F</span>
                  </td>
                  <td>
                  ...
                  <td>
                    @php
                      $assignmentCount = $viewData["assignmentCounts"][$campaign->id] ?? 0;
                    @endphp
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <a href="{{ route('announcer.campaigns.show', ['id' => $campaign->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa fa-eye"></i>
                      </a>
                      @if($campaign->status == 'PENDING')
                      <a href="{{ route('announcer.campaigns.edit', ['id' => $campaign->id]) }}" class="btn btn-warning btn-sm">
                        <i class="fa fa-edit"></i>
                      </a>
                      @endif
                      <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#assignmentsModal" data-campaign-id="{{ $campaign->id }}">
