  ...
  <div class="row">
    <div class="col-xl-12">
      <div class="card">
        ...
        <div class="card-body">
          <form id="createCampaignForm" method="post" action="{{ route('admin.campaigns.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control" name="description" rows="3" placeholder="Décrivez l'objectif de votre campagne..."></textarea>
                </div>
              </div>
            </div>
  ...
  <div class="col-md-12">
    <div class="form-group mb-3">
      ...
      <div class="p-3 border rounded bg-light text-center">
        ...
        <div id="file-preview" class="row mt-3">
