                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0">
                                    {{ number_format($viewData['taskStats']['total_budget'] ?? 0, 0, ',', ' ') }} F</h4>
                            </div>
                            <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                <span class="avatar-title rounded-circle bg-primary">
                                        ...
                                        <select class="form-select" id="filtre_client" name="filtre_client">
                                            ...
                                            @foreach ($viewData['clients'] ?? [] as $client)
                                                <option value="{{ $client->id }}"
                                                    {{ isset($viewData['filtre_client']) && $viewData['filtre_client'] == $client->id ? 'selected' : '' }}>
                                    ...
                                    @forelse($viewData["tasks"] ?? [] as $task)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small
                                                    class="text-muted">{{ Str::limit($task->descriptipon ?? '', 50) }}</small>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-success">{{ number_format($task->budget ?? 0, 0, ',', ' ') }}
                                                    F</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('admin.campaigns.show', ['id' => $task->id]) }}"
                                                        class="btn btn-primary btn-sm">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    @if (($task->status ?? '') == 'PENDING')
                                                        <button class="btn btn-success btn-sm approve-task"
                                                            data-task-id="{{ $task->id }}">
                                                            <i class="fa fa-check"></i>
                                                        </button>
                                                        <button class="btn btn-danger btn-sm reject-task"
                                                            data-task-id="{{ $task->id }}">
