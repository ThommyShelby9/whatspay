                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                        <li><a class="dropdown-item" href="#" id="export-excel"><i
                                                    class="fa fa-file-excel me-2"></i>Excel</a></li>
                                        <li><a class="dropdown-item" href="#" id="export-pdf"><i
                                                    class="fa fa-file-pdf me-2"></i>PDF</a></li>
                                        <li><a class="dropdown-item" href="#" id="export-csv"><i
                                                    class="fa fa-file-csv me-2"></i>CSV</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            @if ($item->id == $item2) selected @endif @endforeach>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2-multiple" id="filtre_contenu"
                                        name="filtre_contenu[]" multiple>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item text-danger" href="#"
                                                        ...
                                                        data-id="{{ $item->id }}"
                                                        data-name="{{ $item->firstname }} {{ $item->lastname }}"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger"><i class="fa fa-exclamation-triangle me-2"></i>Cette action est
                        irréversible et supprimera toutes les données associées à ce diffuseur.</p>
                </div>
