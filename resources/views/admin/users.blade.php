...
<div class="container-fluid">
      ...
      <div class="page-title-box">
        <div class="row">
          ...
          <div class="col-auto">
            ...
            @else
            <a href="{{ route('admin.users', ['group' => request()->route('group')]) }}" class="btn btn-secondary">
  ...
  <div class="collapse mb-4" id="collapseFilters">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form theme-form" method="get" action="{{ route('admin.users', ['group' => request()->route('group')]) }}">
          <div class="row">
            <div class="col-md-3">
              <div class="mb-3">
            ...
            <div class="col-md-3">
              <div class="mb-3">
                ...
                <select class="form-select select2" id="filtre_locality" name="filtre_locality">
                  ...
                  @if(isset($viewData["filtre_country"]) && $viewData["filtre_country"] != "all")
                    @foreach($viewData["localities"] as $item)
                      @if($item->country_id == $viewData["filtre_country"])
                      <option value="{{$item->id}}"
                              @if(isset($viewData["filtre_locality"]) && $item->id == $viewData["filtre_locality"]) selected @endif
                        >{{$item->name}}</option>
                      @endif
                    @endforeach
                  @endif
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="d-flex justify-content-end">
                ...
                <a href="{{ route('admin.users', ['group' => request()->route('group')]) }}" class="btn btn-outline-secondary">Réinitialiser</a>
              </div>
            </div>
          </div>
        ...
        <table class="display table table-striped" id="items_datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="dropdown">
                  <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="dropdownMenuButton-{{$item->id}}" data-bs-toggle="dropdown" aria-expanded="false" data-user-id="{{$item->id}}">
                    Actions
                  </button>
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton-{{$item->id}}">
                    <li><a class="dropdown-item" href="{{ route('admin.users', ['group' => request()->route('group'), 'action' => 'view', 'id' => $item->id]) }}"><i class="fa fa-eye me-2"></i>Voir</a></li>
                    <li><a class="dropdown-item" href="{{ route('admin.users', ['group' => request()->route('group'), 'action' => 'edit', 'id' => $item->id]) }}"><i class="fa fa-edit me-2"></i>Modifier</a></li>
                    @if(strpos($item->profiles ?? '', 'DIFFUSEUR') !== false)
                    <li><a class="dropdown-item" href="{{ route('admin.users', ['group' => request()->route('group'), 'action' => 'stats', 'id' => $item->id]) }}"><i class="fa fa-chart-line me-2"></i>Statistiques</a></li>
                    @endif
        ...
        <div class="col-md-4">
          <div class="text-center mb-4">
            <div class="avatar-xl mx-auto bg-light-primary rounded-circle text-center mb-3">
              <span class="font-size-24">{{substr($viewData['userDetails']->firstname, 0, 1)}}</span>
            </div>
            <h5 class="mb-0">{{$viewData['userDetails']->firstname}} {{$viewData['userDetails']->lastname}}</h5>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <h6>{{number_format($viewData['userDetails']->vuesmoyen ?? 0, 0, ',', ' ')}}</h6>
                </div>
                <div class="col-md-4">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('admin.users.update', ['group' => request()->route('group')]) }}" method="POST">
        @csrf
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="firstname" name="firstname" value="{{$viewData['userDetails']->firstname}}" required>
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
              <label for="lastname" class="form-label">Nom</label>
              <input type="text" class="form-control" id="lastname" name="lastname" value="{{$viewData['userDetails']->lastname}}" required>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email" name="email" value="{{$viewData['userDetails']->email}}" readonly>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="phone" name="phone" value="{{$viewData['userDetails']->phone}}">
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <select class="form-select" id="country_id" name="country_id">
                ...
                <option value="{{$country->id}}" @if($viewData['userDetails']->country_id == $country->id) selected @endif>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="locality_id" name="locality_id">
                ...
                @foreach($viewData["localities"] ?? [] as $locality)
                  ...
                  <option value="{{$locality->id}}" @if($viewData['userDetails']->locality_id == $locality->id) selected @endif>
                    {{$locality->name}}
                  </option>
                  @endif
                @endforeach
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="vuesmoyen" name="vuesmoyen" value="{{$viewData['userDetails']->vuesmoyen ?? 0}}">
            </div>
          </div>
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <select class="form-select" id="study_id" name="study_id">
                ...
                <option value="{{$study->id}}" @if(isset($viewData['userDetails']->study_id) && $viewData['userDetails']->study_id == $study->id) selected @endif>
                  {{$study->name}}
                </option>
                @endforeach
              </select>
          ...
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <select class="form-select" id="lang_id" name="lang_id">
                ...
                <option value="{{$lang->id}}" @if(isset($viewData['userDetails']->lang_id) && $viewData['userDetails']->lang_id == $lang->id) selected @endif>
                  {{$lang->name}}
                </option>
                @endforeach
              </select>
            ...
            <div class="mb-3">
              ...
              <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="enabled">
                  <span id="status-text" class="@if($viewData['userDetails']->enabled) text-success @else text-danger @endif">
                    @if($viewData['userDetails']->enabled) Actif @else Inactif @endif
                  </span>
                </label>
              </div>
            </div>
        ...
        <div class="d-flex justify-content-end mt-4">
          <a href="{{ route('admin.users', ['group' => request()->route('group')]) }}" class="btn btn-secondary me-2">Annuler</a>
        ...
        <div class="col-md-3">
          <div class="card bg-info text-white">
            <div class="card-body">
              ...
              <h2 class="mt-3 mb-0">{{number_format($viewData['stats']['totalEarnings'], 0, ',', ' ')}} FCFA</h2>
            </div>
          </div>
        </div>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const countrySelect = document.getElementById('filtre_country') || document.getElementById('country_id');
  const localitySelect = document.getElementById('filtre_locality') || document.getElementById('locality_id');
  ...
  if (countrySelect && localitySelect) {
    countrySelect.addEventListener('change', function() {
      ...
      if (localitySelect.id === 'filtre_locality') {
        localitySelect.innerHTML = '<option value="all">Toutes les localités</option>';
      } else {
        localitySelect.innerHTML = '<option value="">Sélectionner une localité</option>';
      }
      ...
      if (selectedCountryId !== 'all' && selectedCountryId !== '') {
        try {
          ...
          if (localitiesJson && localitiesJson.value) {
