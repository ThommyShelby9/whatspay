...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
  ...
  <div class="container-fluid p-0">
    <div class="comingsoon auth-bg-video">
      <video class="bgvideo-comingsoon" id="bgvid" poster="/design/admin/assets/images/other-images/coming-soon-bg.jpg" playsinline="" autoplay="" muted="" loop="">
        <source src="/design/admin/assets/video/auth-bg.mp4" type="video/mp4">
      </video>
      <div class="comingsoon-inner text-center"><img src="/design/logo/logo_large.png" alt="" style="height: 100px; width: 300px;">
        <h5>NOUS OUVRONS TRES BIENTOT</h5>
        @if($viewData['userprofile'] == "ANNONCEUR")
          <p>Rendez-vous le 27 Octobre 2025 (&agrave; partir de 12H00)<br>pour commencer &agrave; diffuser vos contenus sur notre r&eacute;seau.<br><a href="/admin/logout">D&eacute;connexion</a></p>
        @elseif($viewData['userprofile'] == "DIFFUSEUR")
          <p>Rendez-vous le 27 Octobre 2025 (&agrave; partir de 12H00)<br>pour commencer &agrave; gagner de l'argent gr&acirc;ce &agrave; vos statuts WhatsApp.<br><a href="/admin/logout">D&eacute;connexion</a></p>
        @endif
        <div class="countdown" id="clock-arrival" data-hours="1" data-minutes="2" data-seconds="3">
          <ul>
            <li><span class="days time"></span><span class="title">jours</span></li>
            <li><span class="hours time"></span><span class="title">heures</span></li>
            <li><span class="minutes time"></span><span class="title">minutes</span></li>
            <li><span class="seconds time"></span><span class="title">secondes</span></li>
          </ul>
        </div>
      </div>
    </div>
...
<!-- Plugins JS start-->
<script src="/design/admin/assets/js/countdown.js"></script>
<!-- Plugins JS Ends-->
<!-- Theme js-->
<script src="/design/admin/assets/js/script.js"></script>
<!-- Plugin used-->
</body>
</html>
