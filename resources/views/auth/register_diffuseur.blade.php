...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            <div class="col-xl-7 p-0"><img class="bg-img-cover bg-center" src="/design/admin/assets/images/login/1.jpg"
                    alt="looginpage"></div>
                    ...
                    <div>
                        <div class="login-main">
                            <div><a class="logo text-start" href="/"><img class="img-fluid for-light"
                                        src="/design/logo/logo_large.png" alt="looginpage"
                                        style="height: 50px; width: 150px;"><img class="img-fluid for-dark"
                                        src="/design/logo/logo_large.png" alt="looginpage"
                                        style="height: 50px; width: 150px;"></a></div>
                            @include('alert')

                            <!-- Circles which indicates the steps of the form:-->
                            <div class="text-center"><span class="step"></span><span class="step"></span><span
                                    class="step"></span></div>
                            <form class="form-wizard" id="registration_form"
                                action="{{ route('admin.register.diffuseur.post') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="theme-form">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <input class="form-control" type="text" id="prenom"
                                                        name="prenom" required placeholder="Prénom(s)"
                                                        value="{{ old('prenom') }}">
                                                </div>
                                                <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" id="phone" name="phone"
                                                    required placeholder="0197******" value="{{ old('phone') }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">Adresse mail</label>
                                            <input class="form-control" type="email" id="email" name="email"
                                                required placeholder="votre@mail.com" value="{{ old('email') }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-input position-relative">
                                                ...
                                                <div class="show-hide"><span class="show"
                                                        data-index="password_confirmation"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="locality" name="locality">
                                                @foreach ($viewData['localities'] as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (old('locality') == $item->id) selected @endif>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">Nombre de vues moyen, journalier, par statut
                                                WhatsApp</label>
                                            <div class="form-input position-relative">
                                                <input class="form-control" type="number" id="vuesmoyen"
                                                    name="vuesmoyen" required placeholder="Vues moyen journalier"
                                                    value="{{ old('vuesmoyen') }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-input position-relative">
                                                <select class="form-select" id="occupation" name="occupation">
                                                    @foreach ($viewData['occupations'] as $item)
                                                        <option value="{{ $item->id }}"
                                                            @if (old('occupation') == $item->id) selected @endif>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                    <option value=""
                                                        @if (old('occupation') == '') selected @endif>Autre</option>
                                                </select>
                                                <div id="autre_occupationDiv"
                                                    style="margin-top: 10px; display: none;">
                                                    <input class="form-control" type="text" id="autre_occupation"
                                                        name="autre_occupation"
                                                        placeholder="Saisissez votre profession"
                                                        value="{{ old('autre_occupation') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="lang" name="lang" required>
                                                @foreach ($viewData['langs'] as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (old('lang') == $item->id) selected @endif>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="study" name="study" required>
                                                @foreach ($viewData['studies'] as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (old('study') == $item->id) selected @endif>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="theme-form">
                                        <div class="form-group">
                                            <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                                                <br>
                                                <h6 class="sub-title">Quelles sont les catégories de publication qui
                                                    vous intéressent?</h6><br>
                                                        ...
                                                        <div class="payment-first">
                                                            <div class="form-check checkbox checkbox-success">
                                                                <input class="form-check-input category-checkbox"
                                                                    id="c_{{ $item->id }}"
                                                                    name="c_{{ $item->id }}" type="checkbox"
                                                                    @if (old("c_$item->id")) checked @endif>
                                                                <label class="form-check-label mb-0"
                                                                    for="c_{{ $item->id }}">{{ $item->name }}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                                                <br>
                                                <h6 class="sub-title">Quelles sont vos types de contenus dominants?
                                                </h6><br>
                                                @foreach ($viewData['contenttypes'] as $item)
                                                    <div class="payment-wrapper">
                                                        <div class="payment-first">
                                                            <div class="form-check checkbox checkbox-success">
                                                                <input class="form-check-input contenttype-checkbox"
                                                                    id="ct_{{ $item->id }}"
                                                                    name="ct_{{ $item->id }}" type="checkbox"
                                                                    @if (old("ct_$item->id")) checked @endif>
                                                                <label class="form-check-label mb-0"
                                                                    for="ct_{{ $item->id }}">{{ $item->name }}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="checkbox p-0">
                                                <input id="termes" name="termes" type="checkbox" required
                                                    @if (old('termes')) checked @endif>
                                                <label class="text-muted" for="termes">J'accepte les <a
                                                        class="ms-2" href="/page/mentions">Termes</a> et <a
                                                        class="ms-2" href="/page/conditions">Conditions</a></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="text-end pt-3">
                                        <button class="btn btn-secondary" id="prevBtn" type="button"
                                            onclick="nextPrev(-1, 'registration_form')"
                                            style="display: none">Précédent</button>
                                        <button class="btn btn-primary" id="nextBtn" type="button"
                                            onclick="nextPrev(1, 'registration_form')">Suivant</button>
                                    </div>
                                </div>

                                <p class="mt-4 mb-0 text-center">Déjà inscrit(e)?<a class="ms-2"
                                        href="{{ route('admin.login') }}">Connexion</a></p>
