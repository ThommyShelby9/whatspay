    ...
    <div class="col-sm-12">
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col">
            <p class="text-muted">Bienvenue, {{ $viewData['userfirstname'] }} {{ $viewData['userlastname'] }} - Suivez vos performances et vos missions</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          <div class="d-flex">
            <div class="flex-grow-1">
              ...
              <h4 class="mb-0">{{ number_format($viewData["earningsStats"]["total_earnings"] ?? 0) }} F</h4>
            </div>
          ...
          <div class="d-flex">
            <div class="flex-grow-1">
              ...
              @php
                ...
                $acceptanceRate = $totalAssignments > 0 ? round(($completedAssignments / $totalAssignments) * 100) : 0;
              @endphp
            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ isset($assignment->created_at) ? date('d/m/Y', strtotime($assignment->created_at)) : 'N/A' }}</td>
                  <td>
    ...
    <div class="col-xl-4">
      <div class="card">
        ...
        <div class="card-body">
          <div class="row g-3">
            <div class="col-6">
              <a href="{{ route('influencer.campaigns.available') }}" class="btn btn-primary btn-lg w-100 d-flex flex-column align-items-center p-3">
                <i class="fa fa-search fa-2x mb-2"></i>
                <span>Parcourir les campagnes</span>
              </a>
            </div>
            <div class="col-6">
              <a href="{{ route('influencer.campaigns.assigned') }}" class="btn btn-success btn-lg w-100 d-flex flex-column align-items-center p-3">
                <i class="fa fa-tasks fa-2x mb-2"></i>
                <span>Mes missions</span>
              </a>
            </div>
            <div class="col-6">
              <a href="{{ route('influencer.earnings') }}" class="btn btn-info btn-lg w-100 d-flex flex-column align-items-center p-3">
                <i class="fa fa-wallet fa-2x mb-2"></i>
                <span>Mes gains</span>
              </a>
            </div>
            <div class="col-6">
              <a href="{{ route('influencer.profile') }}" class="btn btn-warning btn-lg w-100 d-flex flex-column align-items-center p-3">
        ...
        <div class="card-body">
          <div class="mb-4">
            ...
            <div class="progress" style="height: 8px;">
              @php
                $completionPercent = $totalAssignments > 0 ? ($completedAssignments / $totalAssignments) * 100 : 0;
              @endphp
