                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('influencer.campaigns.show', ['id' => $viewData['assignment']->id]) }}">{{ $viewData['assignment']->task_name ?? 'Détails' }}</a>
                                    </li>
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Soumettre les résultats pour :
                            {{ $viewData['assignment']->task_name ?? 'Campagne' }}</h5>
                    </div>
                    <div class="card-body">
                        <form id="submitResultsForm" method="post"
                            action="{{ route('influencer.campaigns.storeSubmission', ['id' => $viewData['assignment']->id]) }}"
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Preuves de diffusion <span
                                        ...
                                        <!-- Input natif (un seul fichier) -->

                                        <input type="file" class="form-control" id="proofFileInput" name="files"
                                            accept="image/*,video/*,application/pdf">

                                        <!-- Nom du fichier sélectionné -->
                                        <div id="selectedFileName" class="form-text mt-1 text-truncate"></div>

                                        <div class="form-text">
                                            Déposez votre fichier ici ou cliquez pour le sélectionner. (Image, vidéo ou PDF)
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="comments" rows="4"
                                            placeholder="Ajoutez des commentaires ou des détails sur les résultats de la campagne..."></textarea>
                                    </div>
                                </div>
                            </div> --}}
                            ...
                            <div class="alert alert-info">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">En soumettant vos résultats, vous confirmez que les informations
                                            fournies sont exactes. La soumission sera examinée par l'annonceur avant
                                            validation finale et paiement.</p>
                                    </div>
                                </div>
                            </div>

                            <div class="text-end mt-4">
                                <a href="{{ route('influencer.campaigns.show', ['id' => $viewData['assignment']->id]) }}"
                            ...
                            <li class="py-2 border-bottom">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-0">{{ number_format($viewData['assignment']->expected_gain ?? 0) }}
                                            F</h6>
                                    </div>
                                </div>
                            </li>
                            <li class="py-2 border-bottom">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-0">
                                            {{ number_format($viewData['assignment']->expected_views ?? 0) }}</h6>
                                    </div>
                                </div>
                            </li>
                            <li class="py-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-0">
                                            {{ $viewData['assignment']->task->client->firstname . ' ' . $viewData['assignment']->task->client->lastname ?? 'N/A' }}
                                        </h6>
                                    </div>
                                </div>
                            </li>
            ...
            $(function() {
                ...
                input.addEventListener('change', function() {
                    if (input.files.length > 0) {
                        ...
                        display.textContent = file.name + ' (' + Math.round(file.size / 1024) +
                            ' KB)';
                    } else {
                        display.textContent = '';
                    }
