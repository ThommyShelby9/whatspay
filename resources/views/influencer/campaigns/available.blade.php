              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" name="filtre_budget_min" value="{{ request()->get('filtre_budget_min') }}" placeholder="Ex: 5000">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group mb-3">
      ...
      <div class="card h-100">
        <div class="card-body">
          ...
          <div class="mt-3 text-center">
            <button type="button" class="btn btn-success btn-sm w-100 apply-btn" data-task-id="{{ $task->id }}" data-bs-toggle="modal" data-bs-target="#applyModal">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body text-center py-5">
          <img src="{{ asset('images/empty-state.svg') }}" alt="Aucune campagne" height="120" class="mb-4">
          <h5>Aucune campagne disponible</h5>
          <p class="text-muted">Il n'y a actuellement aucune campagne disponible correspondant à vos critères.</p>
          <a href="{{ route('influencer.campaigns.available') }}" class="btn btn-primary mt-2">Rafraîchir</a>
        </div>
      </div>
    </div>
    @endforelse
      ...
      <div class="modal-body">
        <form id="applicationForm" method="post">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" name="message" rows="4" placeholder="Expliquez pourquoi vous êtes le meilleur diffuseur pour cette campagne..."></textarea>
          </div>
          
          <div class="mb-3">
            <label class="form-label">Vues estimées</label>
            <input type="number" class="form-control" name="estimated_views" required min="0" placeholder="Ex: 1000">
            <div class="form-text">
