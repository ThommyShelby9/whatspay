                            ...
                            <li class="py-2">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-0">
                                            {{ isset($viewData['userObject']->created_at) ? date('d/m/Y', strtotime($viewData['userObject']->created_at)) : 'N/A' }}
                                        </h6>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="firstname"
                                            value="{{ $viewData['userObject']->firstname ?? '' }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="lastname"
                                            value="{{ $viewData['userObject']->lastname ?? '' }}" required>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <select class="form-select" name="country_id">
                                            ...
                                            @foreach ($viewData['countries'] ?? [] as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ ($viewData['userObject']->country_id ?? '') == $country->id ? 'selected' : '' }}>
                                                    {{ $country->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select class="form-select" name="locality_id">
                                            ...
                                            @foreach ($viewData['localities'] ?? [] as $locality)
                                                <option value="{{ $locality->id }}"
                                                    {{ ($viewData['userObject']->locality_id ?? '') == $locality->id ? 'selected' : '' }}>
                                                    {{ $locality->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                                    ...
                                                    <div class="col-md-4 col-sm-6 mb-2">
                                                        <div class="form-check category-item">
                                                            ...
                                                            <label class="form-check-label"
                                                                ...
                                                                data-bs-toggle="tooltip" title="{{ $category->name }}">
